...
const { getLatestRelease } = __nccwpck_require__(762);
const { updateSection } = __nccwpck_require__(285);
const { autoCommit } = __nccwpck_require__(569);
const { renderTable } = __nccwpck_require__(667);
const { renderList } = __nccwpck_require__(431);
const { renderCard } = __nccwpck_require__(950);
const { renderCompact } = __nccwpck_require__(126);
...
const { formatDate } = __nccwpck_require__(847);
...
const fetch = (__nccwpck_require__(485)/* ["default"] */ .Ay);
